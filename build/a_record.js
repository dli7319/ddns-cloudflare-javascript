...
var ARecord = /*#__PURE__*/function (_Record) {
  _inherits(ARecord, _Record);

  var _super = _createSuper(ARecord);

  function ARecord(recordInfo, parameters) {
    var _this;

    _classCallCheck(this, ARecord);
